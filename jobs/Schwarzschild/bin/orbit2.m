...
function [tp, rp, thetap] = periastron(t,r,theta)
    ...
    [~,min_idx] = findpeaks(-r(:,1)); %%array di indici in cui la distanza tra sole e mercurio è minima
    ...
    for idx = transpose(min_idx)
        ...
        thetap(i) = -b/(2*a); % x coordinate of the vertex
        rp(i) = c-b^2/(4*a); %y coordinate of the vertex
